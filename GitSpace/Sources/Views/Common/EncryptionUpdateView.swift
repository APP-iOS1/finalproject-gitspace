...
struct EncryptionUpdateView: View {
    ...
    @State private var isShowingReadTagAlert = false
    @State private var isShowingReadKnockAlert = false
    
    @State private var isShowingEncryptChatAlert = false
    @State private var isShowingEncryptMessageAlert = false
    @State private var isShowingEncryptTagAlert = false
    @State private var isShowingEncryptKnockAlert = false
